-- Enhanced Client Pipeline Management Schema
-- This migration adds comprehensive pipeline management and todo functionality
...
INSERT INTO pipeline_templates (advisor_id, name, description, stage, todos) VALUES
(1, 'New Client Onboarding', 'Standard tasks for new prospective clients', 'prospecting', 
 '[
   {"title": "Send welcome email", "description": "Send initial welcome and information gathering email", "priority": 2, "category": "email"},
...
(1, 'Proposal Stage', 'Tasks for clients in proposal stage', 'proposal',
 '[
