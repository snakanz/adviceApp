...
const GENERATION_MODES = {
  'auto-summary': {
    ...
    target_length: '180-350 words',
    sections: ['next_steps'],
    instructions: `Write a concise, professional follow-up email body summarising this meeting.

STRUCTURE:
- Opening: 1-2 sentences thanking the client and referencing what the meeting covered
- Discussion summary: 2-3 paragraphs covering the main topics in natural flowing prose, including ALL specific figures, dates, and amounts mentioned
- Next steps: A numbered list of 3-6 concrete action items with clear ownership (I will... / You will... / We will...)
- Closing: 1-2 sentences offering to answer questions

CRITICAL RULES:
- Include ALL specific monetary figures, percentages, dates, and timeframes from the transcript
- Group related topics together naturally
- If a topic was only briefly mentioned, include it in the discussion summary rather than creating a separate section
- Do NOT include sections for topics that were not discussed
- The email should feel bespoke to this specific meeting, not like a form letter`
  },
  'review-summary': {
    id: 'review-summary',
    label: 'Annual Review',
