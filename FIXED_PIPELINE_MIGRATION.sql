-- FIXED Pipeline Enhancement Migration for Advicly
...
-- Add additional pipeline fields to existing clients table (FIXED)
ALTER TABLE clients 
...
ADD COLUMN IF NOT EXISTS assigned_advisor INTEGER REFERENCES users(id) ON DELETE SET NULL; -- FIXED: INTEGER not TEXT
