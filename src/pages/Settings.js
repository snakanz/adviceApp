...
export default function Settings() {
  ...
  return (
    <div className="h-full flex flex-col md:flex-row bg-background">
      ...
      <div className="md:hidden border-b border-border/50 bg-card/50 p-2 overflow-x-auto">
      ...
      {/* Desktop Sidebar */}
      <div className="hidden md:flex w-64 border-r border-border/50 bg-card/50 flex-col">
        {/* User Info Header */}
