...
export default function Pipeline() {
  ...
  useEffect(() => {
    if (!loading && months.length > 0 && currentMonthIndex >= 0) {
      const container = document.getElementById('month-tabs-container');
      if (container) {
        // Calculate scroll position to center the current month
        const buttonWidth = 128; // min-w-[120px] + gap
        const scrollPosition = Math.max(0, (currentMonthIndex * buttonWidth) - (container.offsetWidth / 2) + (buttonWidth / 2));
        container.scrollTo({ left: scrollPosition, behavior: 'smooth' });
      }
    }
  }, [loading, months.length, currentMonthIndex]);
          ...
          <div className="mb-6">
            ...
            <div className="relative group">
              ...
              <Button
                variant="ghost"
                size="sm"
                className="absolute left-0 top-1/2 -translate-y-1/2 z-10 h-12 w-8 p-0 bg-gradient-to-r from-card via-card to-transparent opacity-0 group-hover:opacity-100 transition-opacity"
                onClick={() => {
                  const container = document.getElementById('month-tabs-container');
              ...
              <div
                ...
                className="flex gap-1 overflow-x-auto pb-2 scrollbar-thin scrollbar-thumb-muted scrollbar-track-transparent px-1"
              >
                {months.map((month) => {
                  ...
                  return (
                    <Button
                      ...
                      size="sm"
                      className={cn(
                        "flex-shrink-0 flex flex-col items-center gap-1 h-auto py-3 px-4 min-w-[120px] transition-all",
                        isPast && !isActive && "opacity-50 hover:opacity-75",
              ...
              <Button
                variant="ghost"
                size="sm"
                className="absolute right-0 top-1/2 -translate-y-1/2 z-10 h-12 w-8 p-0 bg-gradient-to-l from-card via-card to-transparent opacity-0 group-hover:opacity-100 transition-opacity"
                onClick={() => {
                  const container = document.getElementById('month-tabs-container');
                  if (container) container.scrollBy({ left: 240, behavior: 'smooth' });
                }}
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
              ...
              <div className="bg-blue-50 dark:bg-blue-950/30 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-sm font-medium text-blue-900 dark:text-blue-100">In Progress</span>
                </div>
              ...
              <div className="bg-yellow-50 dark:bg-yellow-950/30 border border-yellow-200 dark:border-yellow-800 rounded-lg p-4">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-sm font-medium text-yellow-900 dark:text-yellow-100">Waiting to Sign</span>
                </div>
              ...
              <div className="bg-gray-50 dark:bg-gray-950/30 border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-sm font-medium text-gray-900 dark:text-gray-100">Not Written</span>
                </div>
